<template>
	<div width=100%>
		...
		<el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" highlight-current-row
			...
			<el-table-column prop="refineID" label="采购单号" width="100">
			</el-table-column>
			<el-table-column prop="aprice" label="采购金额" width="150">
			</el-table-column>
			<el-table-column prop="tprlce" label="经办人" width="100">
			</el-table-column>
			<el-table-column prop="chagetime" label="采购日期" width="200">
			</el-table-column>
		...
		<el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)">
			<el-table-column prop="refineID" label="采购详情单号" width="100">
			</el-table-column>
			<el-table-column prop="drugID" label="药品名" width="100">
			</el-table-column>
			<el-table-column prop="inventory" label="单位" width="100">
			</el-table-column>
			<el-table-column prop="pprice" label="类型" width="100">
			</el-table-column>
			<el-table-column prop="aprice" label="换算系数" width="150">
			</el-table-column>
			<el-table-column prop="tprlce" label="进价" width="100">
			</el-table-column>
			<el-table-column prop="chagetime" label="数量" width="200">
			</el-table-column>
			<el-table-column prop="operater" label="总金额" width="100">
			</el-table-column>
			<el-table-column prop="operater" label="供应商" width="100">
			</el-table-column>
		</el-table>
		<el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
