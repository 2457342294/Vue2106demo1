<template>
	<div width=100%>
		<el-input placeholder="请输入要查询的操作员" v-model="input" style="width:200px;padding:10px" clearable>
		</el-input>
		...
		<el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)">
			...
			<el-table-column prop="tprlce" label="盈亏" width="200">
			</el-table-column>
			<el-table-column prop="chagetime" label="调价时间" width="200">
			</el-table-column>
			<el-table-column prop="operater" label="操作员" width="200">
			</el-table-column>
		</el-table>
