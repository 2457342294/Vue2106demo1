<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="userTableList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="手机号码" width="180" align="center" prop="phone" />
      <el-table-column label="性别" align="center" prop="sex" :formatter="sexFormatter" />
      <el-table-column label="年龄" align="center" prop="age" />
      <el-table-column label="职位" prop="userRank" align="center" :formatter="userRankFormatter" />
      <el-table-column label="学历" prop="knowledge" align="center" :formatter="knowledgeFormatter" />
      <el-table-column label="身份证号" align="center" prop="createTime" width="200" />
      <el-table-column label="操作" align="center" width="250">
        <template #default="scope">
          <el-button type="text" icon="el-icon-edit" size="mini" @click="handleUpdate(scope.row)">修改</el-button>
          <el-button type="text" icon="el-icon-delete" size="mini" @click="handleDelete(scope.row)">重置密码</el-button>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="姓名" prop="userName">
              <el-input v-model="form.userName" style="width: 240px" placeholder="请输入员工姓名" clearable size="small"/>
            </el-form-item>
          </el-col>
		  
		  <el-col :span="12">
		    <el-form-item label="身份证" prop="userName">
		      <el-input v-model="form.userName" style="width: 240px" placeholder="请输入身份证" clearable size="small"/>
		    </el-form-item>
		  </el-col>
		  ...
		  <el-col :span="12">
		    <el-form-item label="职位" prop="userRank">
		      <el-select
         ...
         <!-- <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="员工简介" prop="introduction">
              <el-input v-model="form.introduction" type="textarea" placeholder="请输入员工简介" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
