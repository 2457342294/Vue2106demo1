		...
		<el-container>
			<el-header style="height: 200px;">
				<div class="hos_not">
					<el-row>
						<el-col :span="16">
							<el-button @click="dialogVisible = true">医嘱执行</el-button>

							<el-button @click="dialogVisibl = true">新增护理记录</el-button>
						</el-col>
						<el-col :span="8">
					...
					<el-row>
						<el-table :data="value" style="width: 100%">
							...
							<el-table-column prop="sex" label="押金总额">
							</el-table-column>
							<el-table-column prop="date" label="费用总额">
							</el-table-column>
			...
			<el-main>
				<el-tabs v-model="activeName">
					...
					<el-tab-pane label="病人消费记录">
						<el-table :data="hu" height="300" style="width: 100%">
							<el-table-column prop="jiuzhenid" label="日期">
							</el-table-column>
							<el-table-column prop="name" label="单据号">
							</el-table-column>
							<el-table-column prop="sex" label="开单人">
							</el-table-column>
							<el-table-column prop="date" label="执行科室">
							</el-table-column>
							<el-table-column prop="age" label="项目名称">
							</el-table-column>
							<el-table-column prop="phone" label="规格">
							</el-table-column>
							<el-table-column prop="address" label="收入项目">
							</el-table-column>
							<el-table-column prop="qm" label="数量">
							</el-table-column>
							<el-table-column prop="qm" label="应收金额">
							</el-table-column>
							<el-table-column prop="qm" label="实收金额">
							</el-table-column>
							<el-table-column prop="qm" label="状态">
							</el-table-column>
						</el-table>
					</el-tab-pane>
				</el-tabs>
				<el-dialog title="护理记录" v-model="dialogVisibl" width="70%" center>
					<template #footer>
						<div class="hs">
							<el-row>
								<el-col :span="8">
									体温：<el-input style="width: 200px;" placeholder="请输入内容"></el-input>
								</el-col>
								<el-col :span="8">
									脉搏：<el-input style="width: 200px;" placeholder="请输入内容"></el-input>
								</el-col>
								<el-col :span="8">
									呼吸：<el-input style="width: 200px;" placeholder="请输入内容"></el-input>
								</el-col>
							...
							<el-row>
								<el-col :span="8">
									血压：<el-input style="width: 200px;" placeholder="请输入内容"></el-input>
								</el-col>
								<el-col :span="8">
									血饱和度：<el-input style="width: 200px;" placeholder="请输入内容"></el-input>
								</el-col>
								<el-col :span="8">
									引流液量：<el-input style="width: 200px;" placeholder="请输入内容"></el-input>
								</el-col>
								
							</el-row>
							<el-row style="text-align: left;">
								<el-col>
									护理备注：<el-input type="textarea" :rows="2" placeholder="请输入内容" style="width: 75%;">
								</el-input>
								</el-col>
							</el-row>
							<el-row>
				...
				<el-dialog title="医嘱执行" v-model="dialogVisible" width="70%" center>
					<template #footer>
						<el-table ref="multipleTable" :data="yizhu" tooltip-effect="dark" style="width: 100%"
